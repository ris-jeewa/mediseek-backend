...
public class KafkaProducerService {
    ...
    public CompletableFuture<SendResult<String, String>> publishHospitalEvent(AppEvent event) {
    ...
    public CompletableFuture<SendResult<String, String>> publishDoctorEvent(AppEvent event) {
        return publishJson(KafkaConfig.TOPIC_DOCTOR_EVENTS, event.entityId(), event);
    }
